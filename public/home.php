...
<div class="container-fluid text-center">
    ...
    <div class="h1 erhs-h1 mt-5">&lt Welcome to ERHS Coding Club &gt</div>
    ...
    <div class="<?php echo $section_classes[0];?> container mt-5 mb-5" id="tab1">
        <div class="h2 text-center erhs-h2 mt-5" >&lt Description &gt</div>
        <div class="p fs-5 mb-5 text-center w-50 erhs-p" >In this club, students are given access to a rich variety of courses covering various coding languages. Students
    ...
    <div class="<?php echo $section_classes[1];?> container mt-5 mb-5" id="tab2">
        <div class="h2 text-center erhs-h2 mt-5" >&lt Content &gt</div>
        <div class="p fs-5 mb-5 text-center w-50 erhs-p" >We teach a variety of real world top programming languages used in today's tech industry such as
    ...
    <div class="<?php echo $section_classes[2];?> container mt-5 mb-5" id="tab3">
        <div class="h2 text-center erhs-h2 mt-5" >&lt Why You Should Join &gt</div>
        <div class="p fs-5 mb-5 text-center w-50 erhs-p" >A main factor colleges look for in students is early passion. This club allows students to do that by giving them
    ...
    <div class="<?php echo $section_classes[3];?> container mt-5 mb-5" id="tab4">
        <div class="h2 text-center erhs-h2 mt-5" >&lt Already Know Coding? &gt</div>
        <div class="p fs-5 mb-5 text-center w-50 erhs-p" >Students that already know coding can sign up to be a course instructor. This allows them to make their own free course
