...
<div class="container">
    <p class="fs-5 text-center mt-5" style="background-color: rgba(202, 202, 187, 0.47); color: white; border-radius: 15px; border: 2px solid white;"><b>You must enroll in courses to play them.<br><br>PLEASE USE A COMPUTER FOR THE BEST EXPERIENCE IN PLAYING COURSES</b></p>
            ...
            <div class="col mt-4">
                <div class="card h-100" style="background-color: dimgrey; border: 4px solid darkgreen;">
                    ...
                    <div class="card-footer">
                        <a class="btn btn-success ms-md-2" role="button" href="<?php echo course_link($course, $ercc_db);?>">Play</a>
                    </div>
                </div>
            </div>
        <?php } ?>
