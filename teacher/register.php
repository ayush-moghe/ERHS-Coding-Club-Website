...
if( is_post_request() ) {
    ...
    $errors = register_teacher( $_POST, $ercc_db);
...
<div class="container-fluid">
    ...
    <form method="post" action="register.php" class="w-75 ps-5 pe-5" style="margin: auto; background-color: rgba(91, 232, 105, 0.63); border-radius: 15px;">
        ...
        <div class="h1 fs-sm-5 erhs-h1 text-center mb-4 mt-3 pe-5 ps-5 pt-3 pb-3" style="font-family: 'Orbitron', sans-serif; text-shadow: 2px 2px 2px white;">Teacher Login/ Register</div>
