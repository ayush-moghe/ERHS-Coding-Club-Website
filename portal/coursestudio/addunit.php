...
if ( is_post_request() ) {
    ...
    if( isset($_POST['add_unit']) ) {
        ...
        add_unit($ercc_db, $target_course['id'], $unit_name);
        redirect_to('addunit.php');
...
<div id="wrapper">
    <div id="sidebar-wrapper">
        <ul class="sidebar-nav">
            ...
            <li class="fs-5 mt-2 text-light"><a style="background-color: white; color: black;" href="addunit.php">Add Unit</a></li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="container-fluid w-75 ps-5 pe-5 pb-5 bg-dark" style="margin: auto; border-radius: 15px;">
                        ...
                        <form method="post" action="addunit.php">
                            ...
                            <div class="h1 fs-sm-5 erhs-h1 text-center mb-4 mt-5" style="font-family: 'Orbitron', sans-serif; text-shadow: 2px 2px 2px white;">Add A Unit</div>

                            <hr style="opacity: 1; color: white; height: 5px;">

                            <div>

                                <label class="form-label mt-2 text-light" for="unit_name">Unit Name</label>
                            ...
                            <button type="submit" name="add_unit" class="btn btn-lg btn-primary mt-3">Create</button>
